...
- **全 ROS2 Humble + TROS 生态** — 一键 `ros2 launch tracked_vehicle person_follow.launch.py` 启动 15 节点感知-决策-执行管线（含 perception_node 融合 + motion_arbiter 仲裁 + motor_bridge 执行）
