...
timeline
    ...
    6 月中旬 : v0.1–v0.4 基础能力 : STM32 固件 · 人体跟随 · 屏显 · 系统精简
    6 月下旬 : v0.5 交互能力 : 手势锁定 · 语音控制 · 开机自启
    7 月上旬 : v0.6–v0.7 感知升级 : LiDAR 接入 · 三层重构 · 资源优化
    7 月中旬 : v0.8 算法深化 : 手势修复 · 融合管线重写 · 障碍物急停
    7 月 20–21 : v0.8.1–0.8.2 固件攻坚 : 抖动根因 · CH6 纵深防御 · 遥控校准
    7 月 22 : v0.9.0 稳定优化 : 跟随修复 · 启动 62s→20s
    7 月下旬 : v0.10.x 语音重构 : 离线 TTS · 听/说分离 · 体验修复
```
